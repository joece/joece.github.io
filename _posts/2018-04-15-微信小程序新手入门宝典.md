...
##### 开发者工具简介
微信 web 开发者工具项目界面如下
![tool page](joece/joece.gthub.io/includes/page.png)

想要熟悉小程序开发，首先就要熟悉这个开发者工具中默认的小程序目录结构
![struct](joece/joece.gthub.io/includes/struct.png)
在项目中，我们可以看到四种文件类型：
